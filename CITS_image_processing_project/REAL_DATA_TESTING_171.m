...
row_dimension = 256;    % Image size
column_dimension = 256; %     || (Probably same as above)
page_dimension = 400;   % Number of evenly spaced voltages applied
file_path = 'H:\MnSi base CITS img';
file_name = 'I(V) TraceUp Tue Feb 18 17.21.39 2014 [171-1]  STM_Spectroscopy STM.asc';
