...
%% Filter the perpendicular lists with built-in filter function
...
% Correct for 1-D filter delay by appending
...
% Unshape the data_mat3
reunshaped_data = reshape(fullyfiltered_data_mat3,90000,200);
